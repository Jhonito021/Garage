    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        <View style={styles.cardActions}>
          <TouchableOpacity onPress={() => handleEdit(item)} style={styles.actionButton}>
            <FontAwesomeIcon icon={faEdit} size={18} color="#e94560" />
          </TouchableOpacity>
      ...
      <View style={styles.cardContent}>
        <Text style={styles.cardText}>
          <FontAwesomeIcon icon={faCar} size={12} color="#aaaaaa" /> {item.immatriculation}
        </Text>
        <Text style={styles.cardText}>
          <FontAwesomeIcon icon={faCalendar} size={12} color="#aaaaaa" /> {item.annee || 'Année non renseignée'}
        </Text>
        <Text style={styles.cardText}>
          <FontAwesomeIcon icon={faGasPump} size={12} color="#aaaaaa" /> {item.type_carburant || 'Non spécifié'}
        </Text>
        <Text style={styles.cardText}>
          <FontAwesomeIcon icon={faTachometerAlt} size={12} color="#aaaaaa" /> {item.kilometrage_actuel?.toLocaleString()} km
        </Text>
      </View>
    </View>
  );
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <FontAwesomeIcon icon={faCar} size={50} color="#aaaaaa" />
          ...
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setModalVisible(false)}>
                <FontAwesomeIcon icon={faTimes} size={24} color="#e94560" />
              </TouchableOpacity>
            </View>
            <ScrollView>
              <TextInput

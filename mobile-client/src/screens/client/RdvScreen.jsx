    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        <Text style={styles.cardTitle}>
          <FontAwesomeIcon icon={faWrench} size={14} color="#e94560" /> {item.service_demande}
        </Text>
      ...
      <View style={styles.cardContent}>
        <Text style={styles.cardText}>
          <FontAwesomeIcon icon={faCalendarAlt} size={12} color="#aaaaaa" /> {new Date(item.date_heure).toLocaleString('fr-FR')}
        </Text>
        <Text style={styles.cardText}>
          <FontAwesomeIcon icon={faCar} size={12} color="#aaaaaa" /> {item.marque} {item.modele} - {item.immatriculation}
        </Text>
        <Text style={styles.cardText}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <FontAwesomeIcon icon={faCalendarAlt} size={50} color="#aaaaaa" />
            ...
            <ScrollView>
              ...
              {vehicules.map((v) => (
                ...
                >
                  ...
                  {formData.vehicule_id === v.id && (
                    <FontAwesomeIcon icon={faCheck} size={16} color="#e94560" />
                  )}
                </TouchableOpacity>
              ))}
              ...
              <View style={styles.creneauxContainer}>
                {creneaux.map((c) => (
                  ...
                  >
                    <FontAwesomeIcon icon={faClock} size={12} color="#f5f5f5" />

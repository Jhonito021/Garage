    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.formContainer}>
          <FontAwesomeIcon icon={faUserPlus} size={50} color="#e94560" style={styles.icon} />
          ...
          <View style={styles.inputContainer}>
            <FontAwesomeIcon icon={faUser} size={20} color="#aaaaaa" style={styles.inputIcon} />
            <TextInput
              style={styles.input}
              placeholder="Nom *"
              placeholderTextColor="#aaaaaa"
          ...
          <View style={styles.inputContainer}>
            <FontAwesomeIcon icon={faPhone} size={20} color="#aaaaaa" style={styles.inputIcon} />
            <TextInput
              style={styles.input}
          ...
          <View style={styles.inputContainer}>
            <FontAwesomeIcon icon={faMapMarkerAlt} size={20} color="#aaaaaa" style={styles.inputIcon} />
            <TextInput
              style={styles.input}
              placeholder="Adresse"
              placeholderTextColor="#aaaaaa"

...
import { faCar, faSignInAlt, faUserPlus, faCalendarCheck, faBell, faCreditCard, faMapMarkerAlt } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.hero}>
        <FontAwesomeIcon icon={faCar} size={50} color="#e94560" />
      ...
      <View style={styles.cardsContainer}>
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Login')}>
          <FontAwesomeIcon icon={faSignInAlt} size={40} color="#e94560" />
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Register')}>
          <FontAwesomeIcon icon={faUserPlus} size={40} color="#e94560" />
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.infoItem}>
          <FontAwesomeIcon icon={faCalendarCheck} size={16} color="#e94560" />
          <Text style={styles.infoItemText}>Prise de rendez-vous en ligne</Text>
        </View>
        <View style={styles.infoItem}>
          <FontAwesomeIcon icon={faCar} size={16} color="#e94560" />
          <Text style={styles.infoItemText}>Gestion de vos véhicules</Text>
        </View>
        <View style={styles.infoItem}>
          <FontAwesomeIcon icon={faBell} size={16} color="#e94560" />
          <Text style={styles.infoItemText}>Rappels d'entretien</Text>
        </View>
        <View style={styles.infoItem}>
          <FontAwesomeIcon icon={faMapMarkerAlt} size={16} color="#e94560" />
          <Text style={styles.infoItemText}>Suivi en temps réel</Text>
        </View>
        <View style={styles.infoItem}>
          <FontAwesomeIcon icon={faCreditCard} size={16} color="#e94560" />

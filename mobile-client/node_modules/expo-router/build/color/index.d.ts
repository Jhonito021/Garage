...
import type { AndroidColorAttrSDK1, AndroidColorAttrSDK5, AndroidColorAttrSDK14, AndroidColorAttrSDK21, AndroidColorAttrSDK23, AndroidColorAttrSDK25, AndroidColorAttrSDK26 } from 'expo-router/src/color/android.attr.types';
import type { AndroidBaseColorSDK1, AndroidBaseColorSDK14, AndroidBaseColorSDK31, AndroidBaseColorSDK34, AndroidBaseColorSDK35, AndroidDeprecatedColor } from 'expo-router/src/color/android.color.types';
import type { AndroidDynamicMaterialColorType } from 'expo-router/src/color/android.dynamic.types';
import type { AndroidStaticMaterialColorType } from 'expo-router/src/color/android.material.types';
import type { IOSBaseColor } from 'expo-router/src/color/ios.types';
export * from 'expo-router/src/color/android.color.types';
export * from 'expo-router/src/color/android.attr.types';
export * from 'expo-router/src/color/android.dynamic.types';
export * from 'expo-router/src/color/android.material.types';
export * from 'expo-router/src/color/ios.types';

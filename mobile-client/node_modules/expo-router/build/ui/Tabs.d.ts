...
import { ExpoTabsScreenOptions, TabNavigationEventMap, TabsContextValue } from 'expo-router/src/ui/TabContext';
import { ScreenTrigger } from 'expo-router/src/ui/common';
export * from 'expo-router/src/ui/TabContext';
export * from 'expo-router/src/ui/TabList';
export * from 'expo-router/src/ui/TabSlot';
export * from 'expo-router/src/ui/TabTrigger';
/**
...
export declare function useTabsWithChildren(options: UseTabsWithChildrenOptions): {
    ...
    describe: (route: import("@react-navigation/native").RouteProp<ParamListBase>, placeholder: boolean) => import("@react-navigation/native").Descriptor<import("expo-router/src/ui/TabContext").ExpoTabsNavigatorScreenOptions, Omit<{
        dispatch(action: Readonly<{
            type: string;
            payload?: object;
            source?: string;
        ...
        setOptions(options: Partial<import("expo-router/src/ui/TabContext").ExpoTabsNavigatorScreenOptions>): void;
    } & {
        setParams(params: Partial<object | undefined>): void;
        replaceParams(params: object | undefined): void;
    ...
    descriptors: Record<string, import("@react-navigation/native").Descriptor<import("expo-router/src/ui/TabContext").ExpoTabsNavigatorScreenOptions, Omit<{
        dispatch(action: Readonly<{
            type: string;
            payload?: object;
            source?: string;

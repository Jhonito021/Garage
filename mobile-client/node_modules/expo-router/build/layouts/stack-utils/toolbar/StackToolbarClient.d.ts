...
import { type ToolbarPlacement } from 'expo-router/src/layouts/stack-utils/toolbar/context';
...
export declare const StackToolbar: {
    ...
    Button: React.FC<import("expo-router/src/layouts/stack-utils/toolbar/StackToolbarButton").StackToolbarButtonProps>;
    Menu: React.FC<import("expo-router/src/layouts/stack-utils/toolbar/StackToolbarMenu").StackToolbarMenuProps>;
    MenuAction: React.FC<import("expo-router/src/layouts/stack-utils/toolbar/StackToolbarMenu").StackToolbarMenuActionProps>;
    SearchBarSlot: React.FC<import("expo-router/src/layouts/stack-utils/toolbar/StackToolbarSearchBarSlot").StackToolbarSearchBarSlotProps>;
    Spacer: React.FC<import("expo-router/src/layouts/stack-utils/toolbar/StackToolbarSpacer").StackToolbarSpacerProps>;
    View: React.FC<import("expo-router/src/layouts/stack-utils/toolbar/StackToolbarView").StackToolbarViewProps>;
    Label: React.FC<import("expo-router/src/layouts/stack-utils/toolbar/toolbar-primitives").StackToolbarLabelProps>;
    Icon: React.FC<import("expo-router/src/layouts/stack-utils/toolbar/toolbar-primitives").StackToolbarIconProps>;
    Badge: React.FC<import("expo-router/src/layouts/stack-utils/toolbar/toolbar-primitives").StackToolbarBadgeProps>;
};

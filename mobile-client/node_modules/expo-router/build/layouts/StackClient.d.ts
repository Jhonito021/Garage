...
import { type StackScreenProps, StackSearchBar } from 'expo-router/src/layouts/stack-utils';
...
declare const RNStack: React.ForwardRefExoticComponent<Omit<Omit<import("@react-navigation/native-stack").NativeStackNavigatorProps, "children" | "layout" | "initialRouteName" | "id" | "screenListeners" | "screenOptions" | "screenLayout" | "UNSTABLE_router" | "UNSTABLE_routeNamesChangeBehavior"> & import("@react-navigation/native").DefaultRouterOptions<string> & {
    ...
    Screen: (props: import("expo-router/src/useScreens").ScreenProps<ExtendedStackNavigationOptions, StackNavigationState<ParamListBase>, NativeStackNavigationEventMap>) => null;
...
declare const Stack: ((props: ComponentProps<typeof RNStack>) => React.JSX.Element) & {
    Screen: (({ children, options, ...rest }: StackScreenProps) => React.JSX.Element) & {
        Title: typeof import("expo-router/src/layouts/stack-utils").StackScreenTitle;
        BackButton: typeof import("expo-router/src/layouts/stack-utils").StackScreenBackButton;
    };
    Protected: React.FunctionComponent<import("expo-router/src/views/Protected").ProtectedProps>;
    Header: typeof import("expo-router/src/layouts/stack-utils/StackHeaderComponent").StackHeaderComponent;
    SearchBar: typeof StackSearchBar;
    Toolbar: {
        (props: import("expo-router/src/layouts/stack-utils").StackToolbarProps): React.JSX.Element;
        Button: React.FC<import("expo-router/src/layouts/stack-utils").StackToolbarButtonProps>;
        Menu: React.FC<import("expo-router/src/layouts/stack-utils").StackToolbarMenuProps>;
        MenuAction: React.FC<import("expo-router/src/layouts/stack-utils").StackToolbarMenuActionProps>;
        SearchBarSlot: React.FC<import("expo-router/src/layouts/stack-utils").StackToolbarSearchBarSlotProps>;
        Spacer: React.FC<import("expo-router/src/layouts/stack-utils").StackToolbarSpacerProps>;
        View: React.FC<import("expo-router/src/layouts/stack-utils").StackToolbarViewProps>;
        Label: React.FC<import("expo-router/src/layouts/stack-utils").StackToolbarLabelProps>;
        Icon: React.FC<import("expo-router/src/layouts/stack-utils").StackToolbarIconProps>;
        Badge: React.FC<import("expo-router/src/layouts/stack-utils").StackToolbarBadgeProps>;
    };
};
